#ifndef PUEO_CORRELATIONSUMMARY_H
#define PUEO_CORRELATIONSUMMARY_H
...
//FIXME this is all sorts of wrong for pueo 
...
class CorrelationSummary: public TObject
{
  ...
  */
  CorrelationSummary(int teventNumber, int tcentreAnt, int nineAnts[6], int deltaT=0, pueo::pol::pol_t pol = pueo::pol::kVertical);
  ...
  */
  ...
  pol::pol_t  pol; ///< The polarization.  // added by peng, since phase center is relavent to the pol.
	double snr;
  ...
  ClassDef(CorrelationSummary,1); ///< One of ROOT's magic macros.
