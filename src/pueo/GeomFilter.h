#ifndef PUEO_ANALYSIS_GEOM_FILTER
#define PUEO_ANALYSIS_GEOM_FILTER
...
//    typedef struct {} notchPlaceholder;  //  whatever is your notch definition data structure
    ...
    virtual void processOne(AnalysisWaveform* wf, const RawHeader * header = 0, int ant = 0, int pol = 0); 
