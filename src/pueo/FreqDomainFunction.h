#ifndef PUEO_FREQ_DOMAIN_FUNCTION
#define PUEO_FREQ_DOMAIN_FUNCTION
...
class FreqDomainFunction 
{
  ...
  public: 
    ...
    FreqDomainFunction (  std::complex<double> (*fn) (double f, const double * pars), 
        int npars, const AbstractResponse * r = 0,
    ...
    void setResponse(const AbstractResponse * r) { response = r; wf_init = false; }
