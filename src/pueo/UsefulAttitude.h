#ifndef _USEFUL_ATTITUDE_H
#define _USEFUL_ATTITUDE_H
...
namespace pueo 
{
  ...
  {
    constexpr double pitch = 0;
    constexpr double roll = 0;
    constexpr double heading = 0;
  }

  class UsefulAttitude : public nav::Attitude 
  {

    public: 

    UsefulAttitude(); 
    UsefulAttitude(const nav::Attitude * attPtr, bool staticPitchAndRoll = true); 
    virtual ~UsefulAttitude(); 
